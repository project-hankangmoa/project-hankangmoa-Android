...
class ReviewActivity : AppCompatActivity() {
    ...
    fun review() {
        ...
        reviewItem.add(ReviewItem("","김지혜", "시적 순간의 생명력으로 재창조했다. 그만의 고유한 방식으로 촬영된 ‘필름다이어리’ 작품들은 지나간 시간들에 살아 움직이는 이미지의 숨결을 불어넣는다. 덧없이 찰나...",null,"2017.12.29"))
        reviewItem.add(ReviewItem("","이재란", "시적 순간의 생명력으로 재창조했다. 그만의 고유한 방식으로 촬영된 ‘필름다이어리’ 작품들은 지나간 시간들에 살아 움직이는 이미지의 숨결을 불어넣는다. 덧없이 찰나...","https://i.pinimg.com/originals/f7/d8/97/f7d8977935a3ef91038141f04e7e759c.png","2017.12.23"))
        reviewItem.add(ReviewItem("","유가희", "시적 순간의 생명력으로 재창조했다. 그만의 고유한 방식으로 촬영된 ‘필름다이어리’ 작품들은 지나간 시간들에 살아 움직이는 이미지의 숨결을 불어넣는다. 덧없이 찰나...","https://i.pinimg.com/originals/f7/d8/97/f7d8977935a3ef91038141f04e7e759c.png","2017.12.29" ))
