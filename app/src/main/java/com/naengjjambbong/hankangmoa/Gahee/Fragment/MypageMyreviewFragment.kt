...
class MypageMyreviewFragment : Fragment() {
    ...
    fun review(v : View) {
        ...
        mypagemyreviewItem.add(MypageMyreviewItem("한강 불꽃 축제","","이재란", "풍경이 너무 예쁜 것 같아요~","https://cdn.univ20.com/wp-content/uploads/2016/09/eaf418aefb7a9c97a6abeff9e7d827a0-1.jpg","2017.12.23" ))
        mypagemyreviewItem.add(MypageMyreviewItem("어벤져스","","유가희", "ㅎㅎㅎㅎ너무 좋은 것 같아용 한번 가보세용",null,"2017.12.29" ))
