...
class MypageMyreviewFragment : Fragment() {
    ...
    fun review(v : View) {
        ...
        mypagemyreviewItem.add(MypageMyreviewItem("한강몽땅 종이배 경주대회","","김지혜", "시적 순간의 생명력으로 재창조했다. 그만의 고유한 방식으로 촬영된 ‘필름다이어리’ 작품들은 지나간 시간들에 살아 움직이는 이미지의 숨결을 불어넣는다. 덧없이 찰나...",null,"2017.12.29" ))
        mypagemyreviewItem.add(MypageMyreviewItem("한강 불꽃 축제","","이재란", "시적 순간의 생명력으로 재창조했다. 그만의 고유한 방식으로 촬영된 ‘필름다이어리’ 작품들은 지나간 시간들에 살아 움직이는 이미지의 숨결을 불어넣는다. 덧없이 찰나...","https://i.pinimg.com/originals/f7/d8/97/f7d8977935a3ef91038141f04e7e759c.png","2017.12.23" ))
        mypagemyreviewItem.add(MypageMyreviewItem("어벤져스","","유가희", "시적 순간의 생명력으로 재창조했다. 그만의 고유한 방식으로 촬영된 ‘필름다이어리’ 작품들은 지나간 시간들에 살아 움직이는 이미지의 숨결을 불어넣는다. 덧없이 찰나...",null,"2017.12.29" ))
